...
public class Communicator {
    ...
    public static class Backend2Proxy {
        ...
        public static void sendPlayerPermissionChangesPacket(UUID playerId) {
            get().send2Proxy(
                    new CommunicationPackets.Backend2Proxy.AnnouncePlayerPermissionChanges(playerId)
            );
        }

        public static void sendGroupPermissionChangesPacket(Set<UUID> playerIds) {
            get().send2Proxy(
                    new CommunicationPackets.Backend2Proxy.AnnounceGroupPermissionChanges(playerIds)
            );
        }
