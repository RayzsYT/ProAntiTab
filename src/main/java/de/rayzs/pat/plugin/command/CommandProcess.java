...
import de.rayzs.pat.plugin.command.commands.local.info.InfoCommand;
import de.rayzs.pat.plugin.command.commands.local.info.PermsCommand;
import de.rayzs.pat.plugin.command.commands.local.info.StatsCommand;
import de.rayzs.pat.plugin.command.commands.local.modify.*;
import de.rayzs.pat.plugin.command.commands.local.modify.list.ListCommand;
import de.rayzs.pat.plugin.command.commands.local.modify.list.ListGroupsCommand;
import de.rayzs.pat.plugin.command.commands.local.modify.list.ListPrioritiesCommand;
import de.rayzs.pat.plugin.command.commands.local.system.NotifyCommand;
import de.rayzs.pat.plugin.command.commands.local.system.PostDebugCommand;
import de.rayzs.pat.plugin.command.commands.local.system.ReloadCommand;
import de.rayzs.pat.plugin.command.commands.local.system.UpdateCommand;
import de.rayzs.pat.plugin.command.commands.server.ServAddCommand;
import de.rayzs.pat.plugin.command.commands.server.ServClearCommand;
import de.rayzs.pat.plugin.command.commands.server.ServRemoveCommand;
import de.rayzs.pat.plugin.command.commands.server.list.ServListCommand;
