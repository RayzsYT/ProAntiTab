...
public class Configurator {
    ...
    public static ConfigurationBuilder get(String fileName, String filePath) {
        ...
        ConfigurationBuilder configurationBuilder = Reflection.isBungeecordServer()
                ? new BungeeConfigurationBuilder(fileName, filePath)
    ...
    public static ConfigurationBuilder get(String fileName) {
        ...
        ConfigurationBuilder configurationBuilder = Reflection.isBungeecordServer()
                ? new BungeeConfigurationBuilder(fileName)
