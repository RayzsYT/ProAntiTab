...
public class Storage {
    ...
    public static ArrayList<String> UNKNOWN_COMMAND, BLOCKED_COMMANDS_LIST, COMMAND_HELP = new ArrayList<>();
    public static List<UUID> NOTIFY_PLAYERS = new ArrayList<>();
    public static String NOTIFY_ALERT, NOTIFY_ENABLED, NOTIFY_DISABLED, CANCEL_COMMANDS_MESSAGE, COMMAND_UNKNOWN, NO_PERMISSIONS, RELOAD_LOADING, RELOAD_DONE,
    ...
    public static boolean USE_UNKNOWN_COMMAND, TURN_BLACKLIST_TO_WHITELIST, CANCEL_COMMANDS, UPDATE_ENABLED, OUTDATED_VERSION = false, CONSOLE_NOTIFICATION_ENABLED = true;
    ...
    public static void load() {
        ...
        BLACKLIST_ADD_FAIL_MESSAGE = (String) CONFIGURATION.getOrSet("blacklist.add.fail", "&c%command% is already in the list!");
        ...
        BLACKLIST_REMOVE_FAIL_MESSAGE = (String) CONFIGURATION.getOrSet("blacklist.remove.fail", "&c%command% is not listed!");
        ...
        GROUP_ADD_FAIL_MESSAGE = (String) CONFIGURATION.getOrSet("group.add.fail", "&c%command% is already in the list of group %group%!");
        ...
        GROUP_REMOVE_FAIL_MESSAGE = (String) CONFIGURATION.getOrSet("group.remove.fail", "&c%command% is not listed in the group %group%!");
    ...
    public static void save() {
        CONFIGURATION
                ...
                .set("custom-unknown-command.enabled", USE_UNKNOWN_COMMAND)
        ...
        if(!Reflection.isBungeecordServer())
            CONFIGURATION.set("custom.unknown-command.enabled", USE_UNKNOWN_COMMAND).set("custom.unknown-command.message", UNKNOWN_COMMAND);

        STORAGE.set("commands", BLOCKED_COMMANDS_LIST).save();
